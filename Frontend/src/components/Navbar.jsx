                    ...
                    <div className="flex items-center relative z-50" id="custom-nav-dropdown">
                        <div className="relative">
                            <button
                                ...
                                className="flex items-center justify-between w-40 px-4 py-2.5 text-sm bg-[#6804a1] border border-white/10 rounded-none hover:bg-white/5 focus:outline-none focus:ring-4 focus:ring-white/5 transition-all duration-200 font-semibold text-white cursor-pointer"
                            >
